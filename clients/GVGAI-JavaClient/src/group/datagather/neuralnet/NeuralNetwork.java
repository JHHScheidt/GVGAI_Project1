...
public class NeuralNetwork {
	...
	public void saveWeights() {
		...
		File file = new File("clients/GVGAI-JavaClient/src/" + Constants.NETWORK_WEIGHTS_DIR);
		if (!file.exists()) file.mkdirs();
		Thread thread = new Thread(new DataSaver(strings, new File("clients/GVGAI-JavaClient/src/" + Constants.NETWORK_WEIGHTS_DIR + "name.txt")));
		thread.start();
	}
